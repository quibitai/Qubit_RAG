...
- If the user asks about calendar events, use the googleCalendar tool EXCLUSIVELY
- If the user asks about Asana tasks or projects, use the asanaMcp tool EXCLUSIVELY
...
export const chatModelConfig: SpecialistConfig = {
  ...
  defaultTools: [
    ...
    'getFileContentsTool',
    'listDocumentsTool',
    'googleCalendar', // For calendar queries in general chat
    'asanaMcp', // For Asana task management
  ],
};
