// Simple script to test n8n webhook connection for the RAG search tool
...
console.log(`Testing RAG Search webhook connection to: ${n8nWebhookUrl}`);
...
async function testWebhook() {
  try {
    ...
    const response = await fetch(n8nWebhookUrl, {
      method: 'POST',
      headers: headers,
      body: JSON.stringify({ query: "What is RAG and how does it work?" }),
    });
